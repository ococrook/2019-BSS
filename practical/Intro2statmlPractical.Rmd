...
## The k-neareest neighbours method
...
One ot learn the parameters and one to predict. It just predicts. We shall try to
...
40) As was done K-NN predict the accuracy of the method.
